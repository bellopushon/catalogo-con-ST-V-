/*
  # Fix plan display issues

  1. Changes
    - Add function to get plan limits safely
    - Update validation functions to use the new function
    - Normalize plan IDs in user records
    - Create user_plan_details view for easier querying
