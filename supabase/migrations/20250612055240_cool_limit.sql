/*
  # Creación de tablas para suscripciones
  ...
  2. Seguridad
    ...
    - Políticas para visualización de planes y suscripciones
  3. Cambios
...
BEGIN
  IF NOT EXISTS (
    ...
    WHERE polname = 'Plans are viewable by everyone' 
    AND tablename = 'plans' 
  ...
  IF NOT EXISTS (
    SELECT 1 FROM pg_policy 
    WHERE polname = 'Users can view own subscriptions' 
