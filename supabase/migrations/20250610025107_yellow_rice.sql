/*
  # Migración simplificada para planes dinámicos

  1. Funciones de validación de límites
    - Validación de límites de tiendas por plan
    - Validación de límites de productos por plan  
    - Validación de límites de categorías por plan

  2. Triggers para aplicar límites
    - Trigger en stores para validar límites de tiendas
    - Trigger en products para validar límites de productos
    - Trigger en categories para validar límites de categorías

  3. Función auxiliar para obtener límites de plan
    - Maneja tanto IDs de texto como UUID
